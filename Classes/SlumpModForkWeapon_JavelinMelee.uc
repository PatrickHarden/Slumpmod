...
*/
class SlumpModForkWeapon_JavelinMelee extends AOCWeapon_JavelinMelee;
...
DefaultProperties
{
	...
	AttachmentClass=class'SlumpModForkWeaponAttachment_Javelin'
	...
	bCanDodge=false
	AlternativeMode=class'SlumpModForkWeapon_JavelinThrow'
