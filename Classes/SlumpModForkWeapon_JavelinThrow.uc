...
class SlumpModForkWeapon_JavelinThrow extends AOCWeapon_JavelinThrow;
...
DefaultProperties
{
	...
	AttachmentClass=class'SlumpModForkWeaponAttachment_JavelinThrow'
	...
	AlternativeMode=class'SlumpModForkWeapon_JavelinMelee'
