...
*/
class SlumpModForkWeapon_BeardedSword extends AOCWeapon_Longsword;
...
DefaultProperties
{
	...
	AttachmentClass=class'SlumpModForkWeaponAttachment_BeardedSword'
	...
	AlternativeMode=class'SlumpModForkWeapon_Bearded'
