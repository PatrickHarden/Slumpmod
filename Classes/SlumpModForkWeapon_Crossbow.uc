...
* Crossbow.
*/
class SlumpModForkWeapon_Crossbow extends SlumpModForkRangeWeapon;
...
DefaultProperties
{
	...
	AttachmentClass=class'SlumpModForkWeaponAttachment_Crossbow'
	...
	WeaponProjectiles(0)=class'SlumpModForkProj_SteelBolt'
