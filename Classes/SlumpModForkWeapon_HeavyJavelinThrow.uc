...
class SlumpModForkWeapon_HeavyJavelinThrow extends AOCWeapon_HeavyJavelinThrow;
...
DefaultProperties
{
	...
	AttachmentClass=class'SlumpModForkWeaponAttachment_HeavyJavelinThrow'
	...
	AlternativeMode=class'SlumpModForkWeapon_HeavyJavelinMelee'
