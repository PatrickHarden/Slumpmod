class SlumpModForkFamilyInfo_Agatha_Knight extends AOCFamilyInfo_Agatha_Knight;
...
DefaultProperties
{
	...
	NewTertiaryWeapons(1)=(CWeapon=class'SlumpModForkWeapon_TowerShield_Agatha')
	NewTertiaryWeapons(2)=(CWeapon=class'SlumpModForkWeapon_Heater_Agatha',bEnabledDefault=true)
	NewTertiaryWeapons(3)=(CWeapon=class'SlumpModForkWeapon_Kite_Agatha')
	NewTertiaryWeapons(4)=(CWeapon=class'SlumpModForkWeapon_Buckler_Agatha')
