...
*/
class SlumpModForkWeaponAttachment_Brandistock extends AOCWeaponAttachment_Brandistock;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'SlumpModForkWeapon_Brandistock'
	WeaponSocket=wep2hpoint

	AttackTypeInfo(0)=(fBaseDamage=50.0, fForce=37500, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=90.0, fForce=34000, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
